    ...
    <>
      <div className="bg-gradient-to-r from-indigo-900 via-purple-900 to-blue-900 text-white pb-20 pt-6 px-6">
        ...
        <div className="flex xs:flex-row  md:items-center justify-between p-6">
          ...
          {/* Button */}
          <div className="mt-4 md:mt-0 flex justify-center items-center space-x-4">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sharmaankit24009@gmail.com" target="_blank" className="inline-flex items-center px-6 py-2 border border-transparent text-lg font-semibold rounded-full shadow-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300">
              Explore
            </a>
          </div>
        </div>
